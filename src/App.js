...
function App() {
  ...
  return (
    <div className="app">
      ...
      <center className="imagen_p"><img src="http://cdn.shopify.com/s/files/1/0306/2104/0780/collections/Icono_Ferreteria-01_1200x1200.png?v=1628189353" VSPACE="50px" ></img></center>
    </div>
